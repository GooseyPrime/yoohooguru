...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Design Guru - YooHoo.Guru"
        description="Get in touch with Design Guru. We're here to help with questions and support."
        url="https://design.yoohoo.guru/contact"
        image="https://design.yoohoo.guru/assets/og-contact.jpg"
      />
