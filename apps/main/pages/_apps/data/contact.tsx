...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Data Guru - YooHoo.Guru"
        description="Get in touch with Data Guru. We&apos;re here to help with questions and support."
        url="https://data.yoohoo.guru/contact"
        image="https://data.yoohoo.guru/assets/og-contact.jpg"
      />
