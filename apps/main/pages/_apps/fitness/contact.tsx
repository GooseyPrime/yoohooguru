...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Fitness Guru - YooHoo.Guru"
        description="Get in touch with Fitness Guru. We're here to help with questions and support."
        url="https://fitness.yoohoo.guru/contact"
        image="https://fitness.yoohoo.guru/assets/og-contact.jpg"
      />
