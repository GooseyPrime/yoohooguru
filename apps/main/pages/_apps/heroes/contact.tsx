...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Hero Gurus - YooHoo.Guru"
        description="Get in touch with Hero Gurus. We&apos;re here to help with questions and support."
        url="https://heroes.yoohoo.guru/contact"
        image="https://heroes.yoohoo.guru/assets/og-contact.jpg"
      />
