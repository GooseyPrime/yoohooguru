...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Photography Guru - YooHoo.Guru"
        description="Get in touch with Photography Guru. We&apos;re here to help with questions and support."
        url="https://photography.yoohoo.guru/contact"
        image="https://photography.yoohoo.guru/assets/og-contact.jpg"
      />
