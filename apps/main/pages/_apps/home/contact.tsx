...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Home Guru - YooHoo.Guru"
        description="Get in touch with Home Guru. We're here to help with questions and support."
        url="https://home.yoohoo.guru/contact"
        image="https://home.yoohoo.guru/assets/og-contact.jpg"
      />
