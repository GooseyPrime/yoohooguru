...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Business Guru - YooHoo.Guru"
        description="Get in touch with Business Guru. We&apos;re here to help with questions and support."
        url="https://business.yoohoo.guru/contact"
        image="https://business.yoohoo.guru/assets/og-contact.jpg"
      />
