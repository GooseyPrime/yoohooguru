    ...
    const fetchPosts = async () => {
      try {
        ...
        const response = await fetch(
          `${apiUrl}/api/gurus/${subdomain}/posts?page=${page}&limit=${limit}${tagParam}`
        );
    ...
    <div>
      ...
      <main className="blog-index-page">
        <div className="blog-header">
          <h1>Mechanical Guru Blog</h1>
          <p>Expert insights, tutorials, and guides for mechanical engineering and design</p>
        </div>
        ...
        <div className="back-link">
          <Link href={`/_apps/${subdomain}`}>← Back to Mechanical Guru Home</Link>
        </div>
      </main>
