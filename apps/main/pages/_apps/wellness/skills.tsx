...
export default function Skills() {
  return (
    <>
      <Seo
        title="Skills - Wellness Guru - YooHoo.Guru"
        description="Explore skills and courses available on Wellness Guru. Start learning today."
        url="https://wellness.yoohoo.guru/skills"
        image="https://wellness.yoohoo.guru/assets/og-skills.jpg"
      />
