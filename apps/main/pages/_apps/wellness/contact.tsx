...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Wellness Guru - YooHoo.Guru"
        description="Get in touch with Wellness Guru. We&apos;re here to help with questions and support."
        url="https://wellness.yoohoo.guru/contact"
        image="https://wellness.yoohoo.guru/assets/og-contact.jpg"
      />
