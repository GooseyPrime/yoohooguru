...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Science Guru - YooHoo.Guru"
        description="Get in touch with Science Guru. We&apos;re here to help with questions and support."
        url="https://science.yoohoo.guru/contact"
        image="https://science.yoohoo.guru/assets/og-contact.jpg"
      />
