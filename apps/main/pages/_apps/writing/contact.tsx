...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Writing Guru - YooHoo.Guru"
        description="Get in touch with Writing Guru. We&apos;re here to help with questions and support."
        url="https://writing.yoohoo.guru/contact"
        image="https://writing.yoohoo.guru/assets/og-contact.jpg"
      />
