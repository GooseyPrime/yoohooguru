...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Coding Guru - YooHoo.Guru"
        description="Get in touch with Coding Guru. We're here to help with questions and support."
        url="https://coding.yoohoo.guru/contact"
        image="https://coding.yoohoo.guru/assets/og-contact.jpg"
      />
