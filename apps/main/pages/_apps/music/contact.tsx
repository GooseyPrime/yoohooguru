...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Music Guru - YooHoo.Guru"
        description="Get in touch with Music Guru. We're here to help with questions and support."
        url="https://music.yoohoo.guru/contact"
        image="https://music.yoohoo.guru/assets/og-contact.jpg"
      />
