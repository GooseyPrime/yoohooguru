...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Gardening Guru - YooHoo.Guru"
        description="Get in touch with Gardening Guru. We're here to help with questions and support."
        url="https://gardening.yoohoo.guru/contact"
        image="https://gardening.yoohoo.guru/assets/og-contact.jpg"
      />
