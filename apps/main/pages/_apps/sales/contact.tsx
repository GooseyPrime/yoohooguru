...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Sales Guru - YooHoo.Guru"
        description="Get in touch with Sales Guru. We're here to help with questions and support."
        url="https://sales.yoohoo.guru/contact"
        image="https://sales.yoohoo.guru/assets/og-contact.jpg"
      />
