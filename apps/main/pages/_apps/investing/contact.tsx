...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Investing Guru - YooHoo.Guru"
        description="Get in touch with Investing Guru. We're here to help with questions and support."
        url="https://investing.yoohoo.guru/contact"
        image="https://investing.yoohoo.guru/assets/og-contact.jpg"
      />
