...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Math Guru - YooHoo.Guru"
        description="Get in touch with Math Guru. We're here to help with questions and support."
        url="https://math.yoohoo.guru/contact"
        image="https://math.yoohoo.guru/assets/og-contact.jpg"
      />
