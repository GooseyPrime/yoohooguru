...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact SkillShare - YooHoo.Guru"
        description="Get in touch with SkillShare. We&apos;re here to help with questions and support."
        url="https://coach.yoohoo.guru/contact"
        image="https://coach.yoohoo.guru/assets/og-contact.jpg"
      />
