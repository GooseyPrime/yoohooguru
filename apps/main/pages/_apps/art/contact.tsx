...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Art Guru - YooHoo.Guru"
        description="Get in touch with Art Guru. We're here to help with questions and support."
        url="https://art.yoohoo.guru/contact"
        image="https://art.yoohoo.guru/assets/og-contact.jpg"
      />
