...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Finance Guru - YooHoo.Guru"
        description="Get in touch with Finance Guru. We&apos;re here to help with questions and support."
        url="https://finance.yoohoo.guru/contact"
        image="https://finance.yoohoo.guru/assets/og-contact.jpg"
      />
