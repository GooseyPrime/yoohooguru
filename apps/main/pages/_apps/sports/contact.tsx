...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Sports Guru - YooHoo.Guru"
        description="Get in touch with Sports Guru. We&apos;re here to help with questions and support."
        url="https://sports.yoohoo.guru/contact"
        image="https://sports.yoohoo.guru/assets/og-contact.jpg"
      />
