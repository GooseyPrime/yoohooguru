...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Tech Guru - YooHoo.Guru"
        description="Get in touch with Tech Guru. We're here to help with questions and support."
        url="https://tech.yoohoo.guru/contact"
        image="https://tech.yoohoo.guru/assets/og-contact.jpg"
      />
