    ...
    <div>
      ...
      <main className="blog-index-page">
        <div className="blog-header">
          <h1>Auto Guru Blog</h1>
          <p>Expert insights, tutorials, and guides for automotive repair and maintenance</p>
        </div>
        ...
        <div className="back-link">
          <Link href={`/_apps/${subdomain}`}>← Back to Auto Guru Home</Link>
        </div>
      </main>
