...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact History Guru - YooHoo.Guru"
        description="Get in touch with History Guru. We&apos;re here to help with questions and support."
        url="https://history.yoohoo.guru/contact"
        image="https://history.yoohoo.guru/assets/og-contact.jpg"
      />
