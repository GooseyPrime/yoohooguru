...
export default function Teachers() {{
  return (
    <>
      <Seo
        title="Teachers - History Guru - YooHoo.Guru"
        description="Meet expert teachers and instructors on History Guru. Learn from the best in the field."
        url="https://history.yoohoo.guru/teachers"
        image="https://history.yoohoo.guru/assets/og-teachers.jpg"
      />
