...
export default function Contact() {{
  return (
    <>
      <Seo
        title="Contact Marketing Guru - YooHoo.Guru"
        description="Get in touch with Marketing Guru. We're here to help with questions and support."
        url="https://marketing.yoohoo.guru/contact"
        image="https://marketing.yoohoo.guru/assets/og-contact.jpg"
      />
