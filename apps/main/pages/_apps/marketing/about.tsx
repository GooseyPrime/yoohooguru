...
export default function About() {{
  return (
    <>
      <Seo
        title="About Marketing Guru - YooHoo.Guru"
        description="Learn about Marketing Guru, Digital Marketing Mastery. Master marketing strategies, digital advertising, and brand building."
        url="https://marketing.yoohoo.guru/about"
        image="https://marketing.yoohoo.guru/assets/og-about.jpg"
      />
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6">
                About
                <span className="block gradient-text-emerald-blue mt-2">Marketing Guru</span>
              </h1>
              <p className="text-xl text-white-80 leading-relaxed">
                Master marketing strategies, digital advertising, and brand building.
              </p>
            </div>
          </div>
        </section>
