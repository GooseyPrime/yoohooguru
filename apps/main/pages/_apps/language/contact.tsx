...
export default function Contact() {
  return (
    <>
      <Seo
        title="Contact Language Guru - YooHoo.Guru"
        description="Get in touch with Language Guru. We&apos;re here to help with questions and support."
        url="https://language.yoohoo.guru/contact"
        image="https://language.yoohoo.guru/assets/og-contact.jpg"
      />
