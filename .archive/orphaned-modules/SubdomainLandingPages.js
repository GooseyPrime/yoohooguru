...
export const CookingLandingPage = () => (
  <SubdomainLandingPage subdomain="cooking" config={subdomainConfigs.cooking} />
);

export const MusicLandingPage = () => (
  <SubdomainLandingPage subdomain="music" config={subdomainConfigs.music} />
);

export const FitnessLandingPage = () => (
  <SubdomainLandingPage subdomain="fitness" config={subdomainConfigs.fitness} />
);

export const TechLandingPage = () => (
  <SubdomainLandingPage subdomain="tech" config={subdomainConfigs.tech} />
);

export const ArtLandingPage = () => (
  <SubdomainLandingPage subdomain="art" config={subdomainConfigs.art} />
);

export const LanguageLandingPage = () => (
  <SubdomainLandingPage subdomain="language" config={subdomainConfigs.language} />
);

export const BusinessLandingPage = () => (
  <SubdomainLandingPage subdomain="business" config={subdomainConfigs.business} />
);

export const DesignLandingPage = () => (
  <SubdomainLandingPage subdomain="design" config={subdomainConfigs.design} />
);

export const WritingLandingPage = () => (
  <SubdomainLandingPage subdomain="writing" config={subdomainConfigs.writing} />
);

export const PhotographyLandingPage = () => (
  <SubdomainLandingPage subdomain="photography" config={subdomainConfigs.photography} />
);

export const GardeningLandingPage = () => (
  <SubdomainLandingPage subdomain="gardening" config={subdomainConfigs.gardening} />
);

export const CraftsLandingPage = () => (
  <SubdomainLandingPage subdomain="crafts" config={subdomainConfigs.crafts} />
);

export const WellnessLandingPage = () => (
  <SubdomainLandingPage subdomain="wellness" config={subdomainConfigs.wellness} />
);

export const FinanceLandingPage = () => (
  <SubdomainLandingPage subdomain="finance" config={subdomainConfigs.finance} />
);

export const HomeLandingPage = () => (
  <SubdomainLandingPage subdomain="home" config={subdomainConfigs.home} />
);