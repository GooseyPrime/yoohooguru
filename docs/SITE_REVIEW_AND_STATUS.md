...
### 1. Content Generation for Subdomains ✅ AI-BASED

**Approach:** All content is generated by AI curation agents, NOT mock data files.

**Subdomains Requiring Initial Content:**
- art, language, business, design, writing, photography
- gardening, crafts, wellness, finance, home, data
- investing, marketing, sales, coding
...
- **News Articles:** Twice daily (6 AM and 3 PM EST) - 2 articles per subdomain
- **Blog Posts:** Weekly (Mondays at 10 AM EST) - 1 post per subdomain
...
- Blog Posts: `Firestore: gurus/{subdomain}/posts`
- Served via API endpoints in `backend/src/routes/gurus.js`
...
### Content Generation System ✅ FULLY IMPLEMENTED
...
- **News Articles:** 2 per day per subdomain, ≤72 hours old, max 10 retained
- **Blog Posts:** 1 per week per subdomain, 1200-2000 words with SEO optimization
